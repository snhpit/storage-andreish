...
namespace Mvc.Web.Tests
{
    ...
    public class ConverterFactoryTest
    {
        ...
        public void CreateTest()
        {
            ...
            IConverterFactory target = new ConverterFactory(resolutionRoot); // TODO: Initialize to an appropriate value
            string provider = string.Empty; // TODO: Initialize to an appropriate value
            IConverter expected = null; // TODO: Initialize to an appropriate value
            IConverter actual;
            actual = target.Create(provider);
